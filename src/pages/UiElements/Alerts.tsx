...
const Alerts = () => {
  return (
    <>
      ...
      <div className="rounded-sm border border-stroke bg-[rgb(var(--c-surface))] p-4 shadow-default dark:border-strokedark md:p-6 xl:p-9">
        <div className="flex flex-col gap-7.5">
          ...
          <div className="flex w-full border-l-6 border-warning bg-warning/15 px-7 py-8 shadow-md dark:bg-[rgb(var(--c-gray-900))]/30 md:p-9">
            ...
            <div className="w-full">
              <h5 className="mb-3 text-lg font-semibold text-[rgb(var(--c-amber-700))]">
                Attention needed
              </h5>
              <p className="leading-relaxed text-[rgb(var(--c-amber-600))]">
          ...
          <div className="flex w-full border-l-6 border-[rgb(var(--c-red-400))] bg-[rgb(var(--c-red-400))]/15 px-7 py-8 shadow-md dark:bg-[rgb(var(--c-gray-900))]/30 md:p-9">
            ...
            <div className="w-full">
              <h5 className="mb-3 font-semibold text-[rgb(var(--c-danger))]">
                There were 1 errors with your submission
              </h5>
              <ul>
                <li className="leading-relaxed text-[rgb(var(--c-meta-7))]">
