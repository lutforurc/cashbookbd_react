...
const BuildingUnitChargesDropdown: React.FC<DropdownProps> = ({
  id,
  name,
  onSelect,
  defaultValue,
  ...
  const loadOptions = async (
    ...
    try {
      const response = await dispatch(unitChargeTypeDdl(inputValue)).unwrap();
...
export default BuildingUnitChargesDropdown;
