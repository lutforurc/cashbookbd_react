...
export const API_DASHBOARD_CASH_BOOK_URL = `${API_BASE_URL}/dashboard/cash-book`;
export const API_DASHBOARD_BRANCHES_URL = `${API_BASE_URL}/dashboard/branches`;
...
// The signed-in user's own password; proven by the current one first.
export const API_USER_CHANGE_PASSWORD_URL = `${API_BASE_URL}/user/change-password`;
...
export const API_PRODUCT_HISTORY_URL = `${API_BASE_URL}/product/history/`;
...
export const API_COMPANY_SCHEME_SUMMARY_URL = `${API_BASE_URL}/company-scheme/summary`;
export const API_COMPANY_SCHEME_MARK_URL = `${API_BASE_URL}/company-scheme/mark`;
