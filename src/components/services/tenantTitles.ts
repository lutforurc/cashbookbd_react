const SIGN_IN_TITLES: Record<string, string> = {
  ...
  "accounts.eworld.cashbookbd.com": "Sign In to MS ISLAMIA DISTRIBUTION HOUSE",
  ...
  "accounts.mbdpp.cashbookbd.com": "Sign In to Ma Babar Dowa Printing Press",
  "accounts.rmr.cashbookbd.com": "Sign In to RMR Multi Mobile Showroom",
};
