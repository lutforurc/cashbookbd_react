  ...
  return (
    <div className="relative flex">
      ...
      <div
        ...
        className={`absolute right-0 top-full z-40 w-40 space-y-1 rounded-sm border border-[rgb(var(--c-border))] bg-[rgb(var(--c-surface))] p-1.5 shadow-default ${dropdownOpen === true ? 'block' : 'hidden'
 }`}
      >
