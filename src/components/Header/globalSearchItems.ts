...
const globalSearchItems: GlobalSearchItem[] = [
  ...
  { title: 'Absent Report', path: routes.hrms_absent_report, group: 'HRM', permissions: ['attendance.view', 'employee.view'], keywords: ['absent missing employee attendance'] },
  { title: 'Late Report', path: routes.hrms_late_report, group: 'HRM', permissions: ['attendance.view', 'employee.view'], keywords: ['late employee attendance deduction'] },
  { title: 'Early Out Report', path: routes.hrms_early_out_report, group: 'HRM', permissions: ['attendance.view', 'employee.view'], keywords: ['early out employee attendance deduction'] },
