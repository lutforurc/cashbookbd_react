...
const globalSearchItems: GlobalSearchItem[] = [
  ...
  { title: 'Cash Received', path: routes.cash_receive, group: 'Transaction', permissions: ['cash.received.create'], keywords: ['cash receive', 'new cash receive', 'money received'] },
  { title: 'Cash Payment', path: routes.cash_payment, group: 'Transaction', permissions: ['cash.payment.create'], keywords: ['new cash payment', 'pay cash'] },
  ...
  { title: 'Sales Invoice', path: routes.inv_sales, group: 'Invoice', permissions: ['sales.create'], keywords: ['new sale', 'sell', 'sales entry'] },
  ...
  { title: 'Customer Opening Import', path: routes.customer_opening_import, group: 'Customer & Supplier', permissions: ['party.opening.edit', 'cs.edit'], keywords: ['opening balance', 'due', 'excel', 'import', 'upload'] },
  ...
  { title: 'Overtime Report', path: routes.hrms_overtime_report, group: 'HRM', permissions: ['attendance.view', 'employee.view'], keywords: ['ot overtime eligible amount minutes attendance'] },
  { title: 'Attendance Alerts', path: routes.hrms_attendance_exception_reports, group: 'HRM', permissions: ['attendance.view', 'employee.view'], keywords: ['absent missing late early out exception report employee attendance deduction'] },
  ...
  { title: 'Branch Attendance Summary', path: routes.hrms_branch_attendance_summary, group: 'HRM', permissions: ['attendance.view', 'employee.view'], keywords: ['branch project attendance summary present absent late'] },
  { title: 'Holiday Calendar', path: routes.hrms_holiday_calendar_report, group: 'HRM', permissions: ['attendance.view', 'employee.view'], keywords: ['holiday calendar weekly holiday attendance'] },
