...
const Header = (props: {
  ...
  return (
    <header className="sticky top-0 z-999 flex w-full bg-[rgb(var(--c-header))] drop-shadow-1 dark:drop-shadow-none">
      <div className="flex grow items-center justify-between px-2 py-2 shadow-2 md:px-6 2xl:px-11">
        <div className="flex items-center gap-2 sm:gap-4 lg:hidden">
          ...
          {props.showSidebarToggle !== false ? (
            <Button
              ...
              className="z-99999 block rounded-sm border border-stroke bg-[rgb(var(--c-surface))] p-1.5 shadow-sm dark:border-strokedark lg:hidden"
            >
