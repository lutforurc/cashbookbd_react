...
/* ================= MAIN COMPONENT ================= */
const CashReceivedPrint = React.forwardRef<HTMLDivElement, Props>(
    ({ data, fontSize = 10 }, ref) => {
        ...
        const headOfAccount = creditEntry?.coa_l4?.name ?? '';
        const amount = Number(creditEntry?.credit ?? 0);
