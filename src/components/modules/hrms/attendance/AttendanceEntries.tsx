...
const AttendanceEntries = ({ user }: any) => {
  ...
  return (
    <div>
      ...
      <div className="mb-3 border border-[rgb(var(--c-border))] bg-[rgb(var(--c-surface))] shadow-default">
        <div className="flex items-center gap-3 border-b border-[rgb(var(--c-border))] px-4 py-2.5 sm:px-6">
 ...
 className="w-full font-medium text-sm p-1.5"
        ...
        <div className="mt-3 flex flex-wrap gap-2 border-t border-[rgb(var(--c-border))] pt-3">
          <ButtonLoading
            type="submit"
 ...
 className="w-full font-medium text-sm p-1.5"
      ...
      <div className="border border-[rgb(var(--c-border))] bg-[rgb(var(--c-surface))] shadow-default">
        <div className="flex items-center justify-between border-b border-[rgb(var(--c-border))] px-4 py-2.5 sm:px-6">
