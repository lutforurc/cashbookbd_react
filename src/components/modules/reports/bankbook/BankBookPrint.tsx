...
export type BankRow = {
  ...
  from_bank?: string | null; // which bank the entry went through
...
type Props = {
  ...
  title?: string; // default 'Bank Book'
...
const BankBookPrint = React.forwardRef<HTMLDivElement, Props>(
  (
    {
      rows,
      startDate,
                ...
                <table className="w-full table-fixed border-collapse">
                  <thead className="bg-gray-100">
                    <tr>
                      ...
                      <th
                        style={{ fontSize: fs }}
                        className={`border border-gray-900 px-2 py-2 w-32`}
                      >
                        Transaction Bank
                      </th>
                      <th
...
BankBookPrint.displayName = 'BankBookPrint';
