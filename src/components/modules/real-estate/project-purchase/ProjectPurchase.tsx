...
import { FiHome, FiPlus, FiRefreshCw, FiSave, FiSearch, FiTrash2 } from 'react-icons/fi';
...
const ProjectPurchase = () => {
  ...
  const handleRemove = (key: string) => setRows((prev) => prev.filter((row) => row.key !== key));
    ...
    <>
          ...
          <div className="sm:col-span-2">
            ...
            <div className="flex items-end gap-2">
              ...
              <ButtonLoading
                ...
                label=" "
                className="h-8.5 w-12 shrink-0 border-[1px] border-gray-600 text-center hover:border-blue-500 sm:w-20"
      ...
      <div className="mt-4 overflow-x-auto">
        <table className="min-w-[760px] w-full text-left text-sm text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            {rows.map((row, index) => (
              <tr key={row.key} className="border-b bg-white dark:border-gray-700 dark:bg-gray-800">
