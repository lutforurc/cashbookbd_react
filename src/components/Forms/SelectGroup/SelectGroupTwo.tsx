    ...
    <div>
      ...
      <div className="relative z-20 bg-white dark:bg-form-input">
        ...
        <Select
          ...
          className={`relative z-20 w-full appearance-none rounded border border-[rgb(var(--c-border))] bg-transparent py-3 px-12 outline-none transition focus:border-primary active:border-primary dark:bg-form-input ${
