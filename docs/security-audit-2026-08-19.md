...
- [~] ২.৩ — স্কোপড lookup। ব্যাচ ১ (৯টি) `ca459d47`; ব্যাচ ২ Party (১.৪/১.৫) `ebfef457`; ব্যাচ ৩ Hrms (১৩টি)। মডিউল ধরে ধরে চলছে
      স্কিমার অভাবে আটকে থাকা দশটির **নয়টিতে** `company_id` বসেছে, তাদের মেথড,
      তালিকা-পড়া, তৈরি করার পথ ও ইউনিক নিয়ম সবই স্কোপড; `inventory_system`-এর ইউনিক
      কী কোম্পানিসহ। `tutorial_videos` মালিকের সিদ্ধান্তে সবার সাধারণ তালিকাই থাকল
