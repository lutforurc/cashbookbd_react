...
class SubscriptionController extends Controller
{
    ...
    public function storePlan(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            'features.*.feature_key' => ['required_with:features', 'string', 'max:120'],
            'features.*.feature_name' => ['required_with:features', 'string', 'max:150'],
            'features.*.feature_value' => ['required_with:features', 'in:0,1'],
